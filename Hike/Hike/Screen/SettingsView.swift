...
//  Hike
//
//  Created by Javier Eduardo Rodriguez Ardila on 16/10/23.
//
    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                VStack(spacing: 8) {
                    Text("Where can you find \nperfect tracks?")
                        .font(.title2)
                        .fontWeight(.heavy)
                    Text("The hike which looks gorgeus in photos is even better once you are actyally there. The hoke that you hope to do again someday. \nFind the best day hikes in the app.")
                        .font(.footnote)
                        .italic()
            ...
            Section (
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "ellipsis.curlybraces", rowContent: "Javier Rodriguez", rowTintColor: .mint)
